...
create table customers(employeeid serial, name varchar(30), username varchar(25) primary key, email varchar(40), password varchar(20));

insert into customers(employeeid, name, username, email, password)
...
create table offers(username varchar(20) references customers(username), carID int references items(carID), offer int, status varchar(10));
insert into offers(username, carid, offer, status) values('msnow007', 103, 32500, 'Pending');
insert into offers(username, carid, offer, status) values('msnow007', 104, 26500, 'Pending');
insert into offers(username, carid, offer, status) values('jojo1', 101, 14500, 'Pending');
...
insert into carsowned(customeruser, carid)
values('msnow007', 103);
